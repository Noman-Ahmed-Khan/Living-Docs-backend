...
@router.post("/me/deactivate", response_model=auth_schema.MessageResponse)
...
@router.post("/me/activate", response_model=auth_schema.MessageResponse)
...
@router.delete("/me", response_model=auth_schema.MessageResponse)
...
@router.get("/me/security-info", response_model=user_schema.SecurityInfo)
